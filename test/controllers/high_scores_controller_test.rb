...
class HighScoresControllerTest < ActionController::TestCase
  ...
  test "should create high_score" do
    assert_difference('HighScore.count') do
      post :create, high_score: { game: @high_score.game, score: @high_score.score, widgets_count: @high_score.widgets_count }
    end
  ...
  test "should update high_score" do
    patch :update, id: @high_score, high_score: { game: @high_score.game, score: @high_score.score, widgets_count: @high_score.widgets_count }
    assert_redirected_to high_score_path(assigns(:high_score))
  end
